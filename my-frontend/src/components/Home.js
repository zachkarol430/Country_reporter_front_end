...
const Home = () => {
  ...
  const handleRandomCountry = async () => {
    ...
    setFlagSrc(null);
    try {
      const res = await axios.get("https://countryreporter-production.up.railway.app/random-country");
  ...
  return (
    <div className="home global-background text-white flex flex-col items-center justify-center min-h-screen">
